...
<div class="container my-4">
    ...
    <div class="dashboard-header mb-4 d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="lead mt-2 mb-0">Pantau pendaftaran & riwayat perjalanan haji Anda dengan mudah</p>
        </div>
        <div>
    ...
    <h4 class="mb-3"><i class="bi bi-clipboard-check"></i> Pendaftaran Terbaru</h4>
    @if($pendaftaran)
        <div class="card shadow-sm mb-4 card-info">
            <div class="card-body">
    ...
    @else
        <div class="alert alert-warning shadow-sm">Belum ada pendaftaran.</div>
